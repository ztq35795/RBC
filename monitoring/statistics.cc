...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {REMAP_COUNTER, "rocksdb.remap.count"},
    {REMAP_FLUSH_COUNTER, "rocksdb.remap_flush.count"},
        {L0_TO_L1_REMAP_COUNTER, "rocksdb.remap.l0.to.l1"},
	  {L1_TO_L2_REMAP_COUNTER, "rocksdb.remap.l1.to.l2"},
	  {L2_TO_L3_REMAP_COUNTER, "rocksdb.remap.l2.to.l3"},
	  {L3_TO_L4_REMAP_COUNTER, "rocksdb.remap.l3.to.l4"},
	  {L4_TO_L5_REMAP_COUNTER, "rocksdb.remap.l4.to.l5"},
    {L0_TO_L1_REMAP_LATENCY, "rocksdb.remap.latency.l0.to.l1"},
	  {L1_TO_L2_REMAP_LATENCY, "rocksdb.remap.latency.l1.to.l2"},
	  {L2_TO_L3_REMAP_LATENCY, "rocksdb.remap.latency.l2.to.l3"},
	  {L3_TO_L4_REMAP_LATENCY, "rocksdb.remap.latency.l3.to.l4"},
	  {L4_TO_L5_REMAP_LATENCY, "rocksdb.remap.latency.l4.to.l5"},
};
