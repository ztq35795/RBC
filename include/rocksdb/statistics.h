...
enum Tickers : uint32_t {
  ...
  REMAP_COUNTER,
  REMAP_FLUSH_COUNTER,
  L0_TO_L1_REMAP_COUNTER,
  L1_TO_L2_REMAP_COUNTER,
  L2_TO_L3_REMAP_COUNTER,
  L3_TO_L4_REMAP_COUNTER,
  L4_TO_L5_REMAP_COUNTER,
  L0_TO_L1_REMAP_LATENCY,
  L1_TO_L2_REMAP_LATENCY,
  L2_TO_L3_REMAP_LATENCY,
  L3_TO_L4_REMAP_LATENCY,
  L4_TO_L5_REMAP_LATENCY,
  TICKER_ENUM_MAX
};
