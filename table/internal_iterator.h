...
//Remap begin
  //Return the file name of the iter
  virtual std::string File() const {
	  std::string fname;
	  return fname;
  }

  //return the offset of the data block
  ...
  //return if is the begin of the data block
  virtual bool Begin() const {
	  return false;
  }

  //return if is the end of the data block
  virtual bool End() const {
	  return false;
  }

  /* indicate that the current key and the last key belong to 
   * the same iterator */
