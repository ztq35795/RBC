...
class MergingIterator : public InternalIterator {
 public:
  ...
  //Remap begin
  virtual std::string File() const override { return current_->File(); }
  virtual uint64_t Length() const override { return current_->Length(); }
  virtual uint64_t Offset() const override { return current_->Offset(); }
  virtual bool Begin() const override { return current_->Begin(); }
  virtual bool End() const override { return current_->End(); }
