...
class LevelIterator final : public InternalIterator {
 public:
  ...
  //Remap begin
  virtual std::string File() const override { return file_iter_.File(); }
  virtual uint64_t Length() const override { return file_iter_.Length(); }
  virtual uint64_t Offset() const override { return file_iter_.Offset(); }
  virtual bool Begin() const override { return file_iter_.Begin(); }
  virtual bool End() const override { return file_iter_.End(); }
